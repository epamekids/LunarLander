...
while H >= 0:
    ...
    if (abs(T - round(T)) <= t / 2):
        ...
        pygame.draw.circle(screen, GREEN, coord((T*SCREEN_SIZE[0]/1700, V*SCREEN_SIZE[1]/2000+SCREEN_SIZE[1]/2)), 3, 3)
        pygame.draw.circle(screen, BLACK, coord((T*SCREEN_SIZE[0]/1700, a*SCREEN_SIZE[1]/20+SCREEN_SIZE[1]/2)), 3, 3)
        pygame.display.update()
